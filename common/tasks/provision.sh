...
# Install packages
apt-get install -y sudo zip unzip htop python3 python3-venv python3-dev python3-pip tmux byobu git jq adoptopenjdk-16-hotspot dirmngr gnupg multitail tree iotop cowsay sl iftop dnsutils traceroute default-libmysqlclient-dev mariadb-client build-essential
